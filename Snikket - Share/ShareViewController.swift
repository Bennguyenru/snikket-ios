...
class ShareViewController: SLComposeServiceViewController {
    ...
    var sharedDefaults = UserDefaults(suiteName: "group.com.hxg.italks.share");
                    ...
                    if let localUrl = item as? URL {
                        ...
                        self.upload(localUrl: localUrl, type: mimeType, handler: {(remoteUrl) in
                            ...
                            if self.sharedDefaults!.integer(forKey: "fileDownloadSizeLimit") > 0 {
                                ...
                                let localUploadDirUrl = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.hxg.italks.shared")!.appendingPathComponent("upload", isDirectory: true);
